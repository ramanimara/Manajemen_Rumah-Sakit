    ...
    <div class="sidebar">
        ...
        <div class="menu-items">
            ...
            <a href="<?= base_url('admin/kedatangan') ?>"
                class="<?= (uri_string() == 'admin/kedatangan') ? 'active' : '' ?>">
                <i class="bi bi-person-check"></i> Kedatangan
            </a>
            <a href="<?= base_url('admin/antrian') ?>"
                class="<?= (uri_string() == 'admin/antrian') ? 'active' : '' ?>">
                <i class="bi bi-people"></i> Antrian
            </a>
            <a href="<?= base_url('admin/hasil-pemeriksaan') ?>"
                class="<?= (uri_string() == 'admin/hasil-pemeriksaan') ? 'active' : '' ?>">
                <i class="bi bi-clipboard2-check"></i> Hasil Pemeriksaan
            </a>
            <a href="<?= base_url('admin/laporan-pembayaran') ?>"
                class="<?= (uri_string() == 'admin/laporan-pembayaran') ? 'active' : '' ?>">
                <i class="bi bi-file-text"></i> Laporan Pembayaran
            </a>
            <a href="<?= base_url('admin/laporan/pengambilan-obat') ?>">
                <i class="bi bi-capsule"></i> Laporan Pengambilan Obat
            </a>
            </a>
